...
export default [
    ...
    { ref: 'dz-button',      src: 'component/controls/Button.js' },
    { ref: 'page_feedback',  src: 'component/controls/PageFeedback.js' },
    { ref: 'alert_banner',   src: 'component/controls/AlertBanner.js' },
    { ref: 'accordion',      src: 'component/lists/Accordion.js' },
    { ref: 'accordion_list', src: 'component/lists/AccordionList.js' },
